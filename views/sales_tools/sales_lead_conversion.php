<div class="mid body">
	<form action="<?=current_url()?>" method="post">
		...
		<div class="floatl">
			...
			<?=form_dropdown('c_phone_type',$this->data->type_tel(),set_value('c_phone_type'))?>
			...
			<select name="c_phone" class="otheropt">
				...
				<option value="<?=$data['phone']?>"><?=tel_format($data['phone'])?></option>
			...
			<?=form_dropdown('c_addr_type',$this->data->type_address(),set_value('c_addr_type'))?>
